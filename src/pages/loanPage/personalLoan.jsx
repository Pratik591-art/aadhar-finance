...
import { ChevronRight, ChevronLeft, Upload, CheckCircle, AlertCircle, IndianRupee, Calendar, MapPin, CreditCard, FileText, Clock, Zap } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-800">Loan Application</h1>
          </div>
          <p className="text-gray-600 text-lg">Step {page} of {showFastTrack ? 6 : 5}</p>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none transition text-lg ${
                      errors.loanAmount ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                ...
                {errors.loanAmount && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.loanAmount}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl focus:outline-none transition text-lg ${
                      errors.monthlySalary ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                ...
                {errors.monthlySalary && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.monthlySalary}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-4 border-2 rounded-xl focus:outline-none transition resize-none text-lg ${
                    errors.loanPurpose ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                  }`}
                ...
                {errors.loanPurpose && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.loanPurpose}
                  </p>
                )}
              </div>
            </div>
        ...
        {page === 2 && (
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <p className="text-gray-600 mb-6">Enter details as per Aadhar card</p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                    errors.fullName ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                  }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                      errors.mobileNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  ...
                  {errors.mobileNumber && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle size={16} />{errors.mobileNumber}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                      errors.dateOfBirth ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  />
                  {errors.dateOfBirth && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle size={16} />{errors.dateOfBirth}
                    </p>
                  )}
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Select Gender *</label>
                  <select
                    name="gender"
                    value={formData.gender}
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                      errors.gender ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition resize-none ${
                    errors.completeAddress ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                  }`}
                ...
                {errors.completeAddress && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.completeAddress}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                      errors.pincode ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  ...
                  {errors.pincode && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle size={16} />{errors.pincode}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                      errors.aadharNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  ...
                  {errors.aadharNumber && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle size={16} />{errors.aadharNumber}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition uppercase ${
                      errors.panNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                    }`}
                  ...
                  {errors.panNumber && (
                    <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                      <AlertCircle size={16} />{errors.panNumber}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                    errors.bankAccountNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                  }`}
                  placeholder="Enter bank account number"
                />
                {errors.bankAccountNumber && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.bankAccountNumber}
                  </p>
                )}
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Confirm Bank Account Number *</label>
                <input
                  type="text"
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition ${
                    errors.confirmBankAccountNumber ? 'border-red-500' : 'border-gray-300 focus:border-blue-600'
                  }`}
                  placeholder="Re-enter bank account number"
                />
                {errors.confirmBankAccountNumber && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.confirmBankAccountNumber}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.ifscCode && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.ifscCode}
                  </p>
                )}
              </div>
            </div>
        ...
        {page === 3 && (
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <p className="text-gray-600 mb-6">All documents must be less than 2 MB</p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition ${
                  errors.aadharFront ? 'border-red-500 bg-red-50' : 'border-blue-300 hover:border-blue-600 bg-blue-50'
                }`}>
                  <input
                    type="file"
                    accept="image/*,.pdf"
                    ...
                    id="aadharFront"
                  />
                  <label htmlFor="aadharFront" className="cursor-pointer flex flex-col items-center gap-2">
                    <Upload size={32} className="text-blue-600" />
                    <span className="text-sm font-medium">
                      {formData.aadharFront ? formData.aadharFront.name : 'Click to upload Aadhar Front'}
                    </span>
                ...
                {previews.aadharFront && (
                  <img src={previews.aadharFront} alt="Preview" className="mt-3 w-32 h-32 object-cover rounded-lg border-2 border-blue-200" />
                )}
                {errors.aadharFront && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.aadharFront}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition ${
                  errors.aadharBack ? 'border-red-500 bg-red-50' : 'border-blue-300 hover:border-blue-600 bg-blue-50'
                }`}>
                  <input
                    type="file"
                    accept="image/*,.pdf"
                    ...
                    id="aadharBack"
                  />
                  <label htmlFor="aadharBack" className="cursor-pointer flex flex-col items-center gap-2">
                    <Upload size={32} className="text-blue-600" />
                    <span className="text-sm font-medium">
                      {formData.aadharBack ? formData.aadharBack.name : 'Click to upload Aadhar Back'}
                    </span>
                    {formData.aadharBack && (
                      <span className="text-xs text-gray-500">
                ...
                {previews.aadharBack && (
                  <img src={previews.aadharBack} alt="Preview" className="mt-3 w-32 h-32 object-cover rounded-lg border-2 border-blue-200" />
                )}
                {errors.aadharBack && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.aadharBack}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition ${
                  errors.panFront ? 'border-red-500 bg-red-50' : 'border-blue-300 hover:border-blue-600 bg-blue-50'
                }`}>
                  <input
                    type="file"
                    accept="image/*,.pdf"
                    ...
                    id="panFront"
                  />
                  <label htmlFor="panFront" className="cursor-pointer flex flex-col items-center gap-2">
                    <Upload size={32} className="text-blue-600" />
                    <span className="text-sm font-medium">
                      {formData.panFront ? formData.panFront.name : 'Click to upload PAN Front'}
                    </span>
                    {formData.panFront && (
                      <span className="text-xs text-gray-500">
                ...
                {previews.panFront && (
                  <img src={previews.panFront} alt="Preview" className="mt-3 w-32 h-32 object-cover rounded-lg border-2 border-blue-200" />
                )}
                {errors.panFront && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.panFront}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition ${
                  errors.panBack ? 'border-red-500 bg-red-50' : 'border-blue-300 hover:border-blue-600 bg-blue-50'
                }`}>
                  <input
                    type="file"
                    accept="image/*,.pdf"
                    ...
                    id="panBack"
                  />
                  <label htmlFor="panBack" className="cursor-pointer flex flex-col items-center gap-2">
                    <Upload size={32} className="text-blue-600" />
                    <span className="text-sm font-medium">
                      {formData.panBack ? formData.panBack.name : 'Click to upload PAN Back'}
                    </span>
                    {formData.panBack && (
                      <span className="text-xs text-gray-500">
                ...
                {previews.panBack && (
                  <img src={previews.panBack} alt="Preview" className="mt-3 w-32 h-32 object-cover rounded-lg border-2 border-blue-200" />
                )}
                {errors.panBack && (
                  <p className="text-red-500 text-sm mt-2 flex items-center gap-1">
                    <AlertCircle size={16} />{errors.panBack}
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl p-8 mb-6">
                ...
                <p className="text-5xl font-bold">{formatCurrency(formData.loanAmount)}</p>
              </div>
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-left space-y-3">
                <h3 className="font-semibold text-gray-800 text-lg mb-3">Application Summary</h3>
                ...
                <p className="text-sm"><span className="font-semibold">Loan Purpose:</span> {formData.loanPurpose}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-6 mb-8">
                <h3 className="text-xl font-semibold text-gray-800 mb-2">Under Review</h3>
                <p className="text-gray-700 text-lg font-medium mb-2">Standard Processing Time</p>
                <p className="text-4xl font-bold text-yellow-600 mb-2">4-5 Days</p>
                <p className="text-sm text-gray-600">Your application is in queue for verification</p>
              </div>
              ...
              <div className="space-y-3 text-left mb-8">
                <div className="flex items-start gap-3 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Documents Submitted</p>
                ...
                <div className="flex items-start gap-3 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Verification Pending</p>
                    <p className="text-sm text-gray-600">Will be processed in 4-5 business days</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-green-50 border-2 border-green-300 rounded-xl p-8 mb-6">
                ...
                <div className="bg-white rounded-lg p-4 inline-block">
                  ...
                  <p className="font-mono font-bold text-lg">{Math.random().toString(36).substr(2, 12).toUpperCase()}</p>
                </div>
              </div>

              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl p-8 mb-6">
                <h3 className="text-2xl font-bold mb-4">Your loan of</h3>
                <p className="text-5xl font-bold mb-4">{formatCurrency(formData.loanAmount)}</p>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start gap-3 bg-green-50 p-4 rounded-lg border border-green-200">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Priority Verification</p>
                    <p className="text-sm text-gray-600">Your documents are being fast-tracked</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-blue-50 p-4 rounded-lg border border-blue-200">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Home Verification Scheduled</p>
                    <p className="text-sm text-gray-600">Bank employee will visit within 24 hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-purple-50 p-4 rounded-lg border border-purple-200">
                  <IndianRupee className="text-purple-600 flex-shrink-0 mt-1" size={24} />
                  <div>
                    <p className="font-semibold text-gray-800">Amount Ready</p>
                    <p className="text-sm text-gray-600">Will be credited to account: XXXX{formData.bankAccountNumber.slice(-4)}</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 bg-blue-50 border-l-4 border-blue-600 p-6 rounded text-left">
                <p className="font-semibold text-gray-800 mb-2">Important Information:</p>
                <ul className="text-sm text-gray-700 space-y-2">
                  ...
                  <li>• SMS and email updates will be sent to your registered contacts</li>
              ...
              <div className="mt-6 bg-gradient-to-r from-gray-700 to-gray-800 text-white p-4 rounded-lg">
                <p className="text-sm"><span className="font-semibold">Application ID:</span> LA-{Math.random().toString(36).substr(2, 10).toUpperCase()}</p>
              </div>
            </div>
          </div>
        )}
